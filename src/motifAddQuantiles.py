...
def addFieldNameQuantileMetadata(standardRecords, sampleRecords, patternID, readName, writeName):
    ...
    For each mapped hit, appends quantile values calculated from a seqlet distribution of the
    considered score. These scores usually will consist of seq-match, contribution-match or
    contribution-magnitude scores.
    """
    standardValues = []
...
def addFieldQuantileData(standardRecords, sampleRecords, recordNames, readName, writeName):
    ...
    For each pattern, appends quantile values calculated from a seqlet distribution of the
    considered score. These scores usually will consist of seq-match, contribution-match or
    contribution-magnitude scores.
    """
...
def addAllMetadata(standardRecords, sampleRecords, recordNames, readNames, writeNames):
    ...
    contribution-match and contribution-magnitude scores.
    """
