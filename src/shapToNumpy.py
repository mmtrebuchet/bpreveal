...
def main():
    ...
    parser.add_argument("--seqs", 
        help="The name of the .npy-format file containing the one-hot-encoded sequences. "
             "This is an output.")
    parser.add_argument("--scores", 
        help="The name of the .npy-format file containing the hypothetical importance scores. "
             "This is an output.")
